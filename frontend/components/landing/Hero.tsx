    ...
    <section className="relative overflow-hidden px-4 pt-20 pb-24 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-[#6c63ff]/30 bg-[#6c63ff]/10 px-3 py-1 text-xs font-medium text-[#6c63ff] mb-6">
            ...
            <p className="mt-5 text-lg text-[#8888aa] leading-relaxed max-w-xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                href="/optimize"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#6c63ff] px-6 py-3.5 text-base font-semibold text-white shadow-lg shadow-[rgba(108,99,255,0.35)] hover:bg-[#5a52e0] hover:shadow-[rgba(108,99,255,0.5)] transition-all"
              >
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#1e1e2e] px-6 py-3.5 text-base font-medium text-[#8888aa] hover:text-white hover:border-[#2e2e4e] transition-all"
              >
                See how it works
              </a>
            </div>
            ...
            {/* Trust badges */}
            <div className="mt-8 flex flex-wrap items-center gap-5 text-xs text-[#8888aa]">
...
function HeroIllustration() {
  return (
    <div className="relative">
      {/* Score card mock */}
      <div className="w-[360px] rounded-2xl border border-[#1e1e2e] bg-[#12121a] p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className="rounded-xl bg-[#0a0a0f] p-4 text-center border border-[#1e1e2e]">
            <p className="text-xs text-[#8888aa] mb-1">Before</p>
            <p className="text-3xl font-black text-[#ef4444]">38</p>
            <p className="text-xs text-[#8888aa]">/ 100</p>
          </div>
          <div className="rounded-xl bg-[#6c63ff]/10 p-4 text-center border border-[#6c63ff]/30">
        ...
        <div className="mt-5 flex gap-2">
          ...
          <div className="flex-1 rounded-lg border border-[#1e1e2e] py-2.5 text-center text-xs font-medium text-[#8888aa]">
            Cover Letter
          </div>
        </div>
      </div>
